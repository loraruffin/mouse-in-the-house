...
destroy_list = [],
    ...
    //Sounds
    soundSpace = new buzz.sound('../sounds/space.wav');
    soundBang = new buzz.sound('../sounds/hit1.wav');
    soundCollect = new buzz.sound('../sounds/collect.wav');
    soundEnd = new buzz.sound('../sounds/end.wav');
